...
srun --gres=gpu:4 -c 24 -l -w guppy36 bash run_wt103_deq_transformer.sh train --name 0.8sgd_0.0fpm_brdn --reg_sgd 0.8 --reg_fpm 0.0
#srun --gres=gpu:4 -c 24 -l -w guppy32 bash run_wt103_deq_transformer.sh train --name 1.0sgd_0.0fpm_brdn --reg_sgd 1.0 --reg_fpm 0.0

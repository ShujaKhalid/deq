...
# Regularization term to the training (perplexity) objective (txp GPUs for consistency --> 34, 31, 25, 35, 36, 32, 28, 21)
#srun --gres=gpu:4 -c 24 -l -w guppy34 bash run_wt103_deq_transformer.sh train --name 0.0sgd_0.0fpm_brdn --reg_sgd 0.0 --reg_fpm 0.0
#srun --gres=gpu:4 -c 24 -l -w guppy31 bash run_wt103_deq_transformer.sh train --name 0.2sgd_0.0fpm_brdn --reg_sgd 0.2 --reg_fpm 0.0
#srun --gres=gpu:4 -c 24 -l -w guppy25 bash run_wt103_deq_transformer.sh train --name 0.4sgd_0.0fpm_brdn --reg_sgd 0.4 --reg_fpm 0.0
#srun --gres=gpu:4 -c 24 -l -w guppy35 bash run_wt103_deq_transformer.sh train --name 0.6sgd_0.0fpm_brdn --reg_sgd 0.6 --reg_fpm 0.0
srun --gres=gpu:4 -c 24 -l -w guppy32 bash run_wt103_deq_transformer.sh train --name 0.8sgd_0.0fpm_brdn --reg_sgd 0.8 --reg_fpm 0.0
#srun --gres=gpu:4 -c 24 -l -w guppy36 bash run_wt103_deq_transformer.sh train --name 1.0sgd_0.0fpm_brdn --reg_sgd 1.0 --reg_fpm 0.0

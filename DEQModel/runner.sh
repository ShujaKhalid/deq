...
# Regularization term to the training (perplexity) objective (txp GPUs for consistency)
...
#srun --gres=gpu:4 -c 24 -l -w guppy28 bash run_wt103_deq_transformer.sh train --name 1.0sgd_0.0fpm_brdn --reg_sgd 1.0 --reg_fpm 0.0
